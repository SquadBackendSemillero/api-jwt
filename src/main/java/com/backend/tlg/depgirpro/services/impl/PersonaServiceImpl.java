...
public class PersonaServiceImpl implements PersonaService {
    ...
    public ResponseEntity<?> insertar(RegistroPersonaDTO dto) {
        ...
        Persona personaNew=this.personaRep.save(new Persona(
                ...
                equipoBD,
                rolJugador));
        respuesta.put("persona", new PersonaResponseDTO(
                personaNew.getId(),
                personaNew.getNombre(),
                personaNew.getEdad(),
                personaNew.getPeso(),
                personaNew.getAltura(),
                personaNew.getCorreo(),
                personaNew.getDorsal(),
                personaNew.getEquipo().getNombre()));
