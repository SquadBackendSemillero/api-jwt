...
public class TorneoServiceImpl implements TorneoService {
    ...
    public ResponseEntity<?> insertar(RegistroTorneoDTO dto) {
        ...
        TorneoResponseDTO resp=new TorneoResponseDTO(torneoNew.getId(), torneoNew.getFechaInicial().getFecha(), torneoNew.getFechaFinal().getFecha());
        respuesta.put("torneo", resp);
    ...
    public ResponseEntity<?> agregarEncuentro(Long idTorneo, RegistroEncuentroDTO dto) {
        ...
        EncuentroResponseDTO resp=new EncuentroResponseDTO(encuentroNew.getId(), encuentroNew.getEquipoLocal().getNombre(), encuentroNew.getEquipoVisitante().getNombre(), encuentroNew.getFecha().getFecha(), encuentroNew.getJornada());
        respuesta.put("encuentro", resp);
        return ResponseEntity.status(HttpStatus.CREATED).body(respuesta);
    }
}
